...
class NetworkMonitorApp:
    def __init__(self, root):
        ...
        root.title("Scan Guard Pro Beta")
        ...
        # Separator and Minimize to Tray Button
        ttk.Separator(self.button_frame, orient='horizontal').grid(row=1, column=0, columnspan=3, sticky='ew', pady=(5, 2))

        self.tray_button = ttk.Button(self.button_frame, text="Minimize to Tray", command=self.minimize_to_tray)
        self.tray_button.grid(row=2, column=0, columnspan=3, padx=5, pady=(2, 5), sticky="ew")
    ...
    def create_tray_icon(self):
        ...
        self.tray_icon = pystray.Icon("Scan Guard Pro", image, "Scan Guard Pro", menu=pystray.Menu(
